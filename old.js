commit 0848f25b208cd5e6472effa181a3bea433593e98
Author: OXOOOOX <171162984+OXOOOOX@users.noreply.github.com>
Date:   Thu Apr 23 01:56:13 2026 +0800

    feat: 重新实现豆包 TTS 语音合成功能
    
    - 新建 tts.js: 简化版的豆包 TTS WebSocket 客户端
      - 基于火山引擎 V3 双向流式 API 协议
      - 支持连接管理、session 管理
      - 支持事件回调和音频数据回调
    
    - 更新 main.js: 集成 TTS 播放功能
      - playTTS(): 完整的 TTS 播报流程
      - splitSentences(): 按标点分句合成
      - playNextAudio(): 音频队列播放
      - stopTTS(): 支持打断功能
    
    - 更新 server.js: WebSocket 代理支持 TTS
      - 自动识别 ASR/TTS 请求 (通过 resource_id)
      - 统一转发到豆包 WebSocket 服务
    
    Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>

diff --git a/tts.js b/tts.js
new file mode 100644
index 0000000..2a296de
--- /dev/null
+++ b/tts.js
@@ -0,0 +1,359 @@
+/**
